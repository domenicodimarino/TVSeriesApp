    ...
    seasons: [
      ...
      Series(
        ...
        episodes: [
          ...
          Episode(episodeNumber: 8, title: 'The Merger', watched: false),
          Episode(episodeNumber: 9, title: 'The Convict', watched: false),
          Episode(episodeNumber: 10, title: 'A Benihana Christmas', watched: false),
          Episode(episodeNumber: 11, title: 'Back from Vacation', watched: false),
          Episode(episodeNumber: 12, title: 'Traveling Salesmen', watched: false),
          Episode(episodeNumber: 13, title: 'The Return', watched: false),
          Episode(episodeNumber: 14, title: 'Ben Franklin', watched: false),
          Episode(episodeNumber: 15, title: 'Phyllis\' Wedding', watched: false),
          Episode(episodeNumber: 16, title: 'Business School', watched: false),
          Episode(episodeNumber: 17, title: 'Cocktails', watched: false),
          Episode(episodeNumber: 18, title: 'The Negotiation', watched: false),
          Episode(episodeNumber: 19, title: 'Safety Training', watched: false),
          Episode(episodeNumber: 20, title: 'Product Recall', watched: false),
          Episode(episodeNumber: 21, title: 'Women\'s Appreciation', watched: false),
          Episode(episodeNumber: 22, title: 'Beach Games', watched: false),
          Episode(episodeNumber: 23, title: 'The Job', watched: false),
        ],
          ),
          Season(
        seasonNumber: 4,
        name: 'Stagione 4',
        episodes: [
          Episode(episodeNumber: 1, title: 'Fun Run', watched: false),
          Episode(episodeNumber: 2, title: 'Dunder Mifflin Infinity', watched: false),
          Episode(episodeNumber: 3, title: 'Launch Party', watched: false),
          Episode(episodeNumber: 4, title: 'Money', watched: false),
          Episode(episodeNumber: 5, title: 'Local Ad', watched: false),
          Episode(episodeNumber: 6, title: 'Branch Wars', watched: false),
          Episode(episodeNumber: 7, title: 'Survivor Man', watched: false),
          Episode(episodeNumber: 8, title: 'The Deposition', watched: false),
          Episode(episodeNumber: 9, title: 'Dinner Party', watched: false),
          Episode(episodeNumber: 10, title: 'Chair Model', watched: false),
          Episode(episodeNumber: 11, title: 'Night Out', watched: false),
          Episode(episodeNumber: 12, title: 'Did I Stutter?', watched: false),
          Episode(episodeNumber: 13, title: 'Job Fair', watched: false),
          Episode(episodeNumber: 14, title: 'Goodbye, Toby', watched: false),
        ],
          ),
          Season(
        seasonNumber: 5,
        name: 'Stagione 5',
        episodes: [
          Episode(episodeNumber: 1, title: 'Weight Loss', watched: false),
          Episode(episodeNumber: 2, title: 'Business Ethics', watched: false),
          Episode(episodeNumber: 3, title: 'Baby Shower', watched: false),
          Episode(episodeNumber: 4, title: 'Crime Aid', watched: false),
          Episode(episodeNumber: 5, title: 'Employee Transfer', watched: false),
          Episode(episodeNumber: 6, title: 'Customer Survey', watched: false),
          Episode(episodeNumber: 7, title: 'Business Trip', watched: false),
          Episode(episodeNumber: 8, title: 'Frame Toby', watched: false),
          Episode(episodeNumber: 9, title: 'The Surplus', watched: false),
          Episode(episodeNumber: 10, title: 'Moroccan Christmas', watched: false),
          Episode(episodeNumber: 11, title: 'The Duel', watched: false),
          Episode(episodeNumber: 12, title: 'Prince Family Paper', watched: false),
          Episode(episodeNumber: 13, title: 'Stress Relief', watched: false),
          Episode(episodeNumber: 14, title: 'Lecture Circuit', watched: false),
          Episode(episodeNumber: 15, title: 'Blood Drive', watched: false),
          Episode(episodeNumber: 16, title: 'Golden Ticket', watched: false),
          Episode(episodeNumber: 17, title: 'New Boss', watched: false),
          Episode(episodeNumber: 18, title: 'Two Weeks', watched: false),
          Episode(episodeNumber: 19, title: 'Dream Team', watched: false),
          Episode(episodeNumber: 20, title: 'Michael Scott Paper Company', watched: false),
          Episode(episodeNumber: 21, title: 'Heavy Competition', watched: false),
          Episode(episodeNumber: 22, title: 'Broke', watched: false),
          Episode(episodeNumber: 23, title: 'Casual Friday', watched: false),
          Episode(episodeNumber: 24, title: 'Cafe Disco', watched: false),
          Episode(episodeNumber: 25, title: 'Company Picnic', watched: false),
        ],
          ),
          Season(
        seasonNumber: 6,
        ...
        episodes: [
          ...
          Episode(episodeNumber: 2, title: 'The Meeting', watched: false),
          Episode(episodeNumber: 3, title: 'The Promotion', watched: false),
          Episode(episodeNumber: 4, title: 'Niagara', watched: false),
          Episode(episodeNumber: 5, title: 'Mafia', watched: false),
          Episode(episodeNumber: 6, title: 'The Lover', watched: false),
          Episode(episodeNumber: 7, title: 'Koi Pond', watched: false),
          Episode(episodeNumber: 8, title: 'Double Date', watched: false),
          Episode(episodeNumber: 9, title: 'Murder', watched: false),
          Episode(episodeNumber: 10, title: 'Shareholder Meeting', watched: false),
          Episode(episodeNumber: 11, title: 'Scott\'s Tots', watched: false),
          Episode(episodeNumber: 12, title: 'Secret Santa', watched: false),
          Episode(episodeNumber: 13, title: 'The Banker', watched: false),
          Episode(episodeNumber: 14, title: 'Sabre', watched: false),
          Episode(episodeNumber: 15, title: 'Manager and Salesman', watched: false),
          Episode(episodeNumber: 16, title: 'The Delivery', watched: false),
          Episode(episodeNumber: 17, title: 'St. Patrick\'s Day', watched: false),
          Episode(episodeNumber: 18, title: 'New Leads', watched: false),
          Episode(episodeNumber: 19, title: 'Happy Hour', watched: false),
          Episode(episodeNumber: 20, title: 'Secretary\'s Day', watched: false),
          Episode(episodeNumber: 21, title: 'Body Language', watched: false),
          Episode(episodeNumber: 22, title: 'The Cover-Up', watched: false),
          Episode(episodeNumber: 23, title: 'The Chump', watched: false),
          Episode(episodeNumber: 24, title: 'Whistleblower', watched: false),
        ],
          ),
          Season(
        seasonNumber: 7,
        ...
        episodes: [
          ...
          Episode(episodeNumber: 9, title: 'WUPHF.com', watched: false),
          Episode(episodeNumber: 10, title: 'China', watched: false),
          Episode(episodeNumber: 11, title: 'Ultimatum', watched: false),
          Episode(episodeNumber: 12, title: 'The Seminar', watched: false),
          Episode(episodeNumber: 13, title: 'The Search', watched: false),
          Episode(episodeNumber: 14, title: 'PDA', watched: false),
          Episode(episodeNumber: 15, title: 'Threat Level Midnight', watched: false),
          Episode(episodeNumber: 16, title: 'Todd Packer', watched: false),
          Episode(episodeNumber: 17, title: 'Garage Sale', watched: false),
          Episode(episodeNumber: 18, title: 'Training Day', watched: false),
          Episode(episodeNumber: 19, title: 'Michael\'s Last Dundies', watched: false),
          Episode(episodeNumber: 20, title: 'Goodbye, Michael', watched: false),
          Episode(episodeNumber: 21, title: 'The Inner Circle', watched: false),
          Episode(episodeNumber: 22, title: 'Dwight K. Schrute, (Acting) Manager', watched: false),
          Episode(episodeNumber: 23, title: 'Search Committee', watched: false),
        ],
          ),
          Season(
        seasonNumber: 8,
